...
${OBJECTDIR}/hidlcd.o: hidlcd.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -I../hidapi/hidapi -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hidlcd.o hidlcd.c
...
${TESTDIR}/tests/hidapi_test.o: tests/hidapi_test.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -I../hidapi/hidapi -I../hidapi/build/src/linux -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/hidapi_test.o tests/hidapi_test.c


${OBJECTDIR}/hidlcd_nomain.o: ${OBJECTDIR}/hidlcd.o hidlcd.c 
	${MKDIR} -p ${OBJECTDIR}
	@NMOUTPUT=`${NM} ${OBJECTDIR}/hidlcd.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -I../hidapi/hidapi -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hidlcd_nomain.o hidlcd.c;\
	else  \
	    ${CP} ${OBJECTDIR}/hidlcd.o ${OBJECTDIR}/hidlcd_nomain.o;\
	fi
